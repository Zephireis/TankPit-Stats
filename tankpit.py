...
@client.command(pass_context=True)
async def tpmeme2(ctx):
    possible_responses = ['https://cdn.discordapp.com/attachments/311890399767822359/942111855562854440/Screen_Shot_2022-02-12_at_12.36.03_PM.png',
